...
$(document).ready(function(){
  ...
  //call the getBookmarks fn, and when we get a response back from the server, add each item to the store, and render it 
  api.getBookmarks(bookmarks => {
    bookmarks.forEach(bookmark=>{
      bookmark.expanded = false; //add this in manually bc server doesnt include this as a property
      bookmark.editing = false; //add this in manually bc server doesnt include this as a property
